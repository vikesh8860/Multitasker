...
class Photo_ocr_class(QtGui.QWidget):
    ...
    def save_method(self):
        ...
        file = open(name,'w')
        temp_file = open("C:\\Users\\Vikesh PC\\Desktop\\Main_Project\\Data\\result.txt",'r')
        text = temp_file.read()
        file.write(text)
        os.remove("C:\\Users\\Vikesh PC\\Desktop\\Main_Project\\Data\\result.txt")
        file.close()
        ...
        if len(temp_list):
            ...
            for one_file in temp_list:
                if one_file.lower().endswith(('.png', '.jpg', '.jpeg')):
                    ...
                    self.listWidget.setIconSize(QtCore.QSize(350,200))  # to set uniform size to each item
...
class Text_to_speech_class(QtGui.QWidget):
    ...
    def convert_speech_method(self):
        ...
        if len(self.text) >0:
            ...
            mixer.music.load('C:\\Users\\Vikesh PC\\Desktop\\Main_Project\\Data\\hello.mp3')
